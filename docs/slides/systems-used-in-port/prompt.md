...
* Generate infographics for `systems used in port`
...
Plans where and when each vessel berths
* Crane Scheduling
...
* Vessels broadcast Automatic Identification System (AIS) data containing Vessel Arrival ETA to TOS. example:
AIS data exampleVessel Name: OCEAN TRADER
          Status: Under Way 
